...
// --------------------------------------------------------------------------------------------------
void
checkEvtTool::addJson( std::string myJson )
{
  hasJson = true;
...
void
checkEvtTool::makeJsonMap( bool savejson, std::string saveAs )
{
  if( !hasJson ){
...
void
checkEvtTool::saveJson( std::string saveAs )
{
  if( !hasJsonMap ){
...
bool
checkEvtTool::isGoodEvt( int runNumber, int LumiSec )
{
...
// --------------------------------------------------------------------------------------------------
void
checkEvtTool::checkChars( char* nameInput, std::string& nameOutput, int& status )
{
